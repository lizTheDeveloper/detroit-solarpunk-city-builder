...
describe('PROJECT_CATALOG', () => {
  ...
  describe('Ecology projects (awakening)', () => {
    it('food_forest has correct values', () => {
      ...
      expect(p.baseCost).toBe(0.10);
      expect(p.baseDuration).toBe(9);
      expect(p.effects.tileEco).toBe(12);
      expect(p.effects.foodSov).toBe(8);
      expect(p.effects.trust).toBe(2);
      expect(p.effects.annualRevenue).toBe(0.02);
    ...
    it('soil_remediation has correct values', () => {
      ...
      expect(p.category).toBe('ecology');
      expect(p.baseCost).toBe(0.50);
      expect(p.baseDuration).toBe(15);
    ...
    it('native_planting has correct values', () => {
      ...
      expect(p.name).toBe('Native Prairie Meadow');
      expect(p.category).toBe('ecology');
      expect(p.baseCost).toBe(0.08);
      expect(p.baseDuration).toBe(6);
      expect(p.effects.tileEco).toBe(9);
      expect(p.effects.foodSov).toBe(0);
      expect(p.effects.trust).toBe(1);
      expect(p.effects.annualRevenue).toBe(0);
      expect(p.maxContamination).toBeNull();
  ...
  describe('Infrastructure projects (awakening)', () => {
    it('solar_grid has correct values', () => {
      ...
      expect(p.name).toBe('Community Solar Grid');
      expect(p.category).toBe('infrastructure');
      expect(p.baseCost).toBe(0.40);
      expect(p.baseDuration).toBe(9);
      expect(p.effects.tileEco).toBe(5);
      expect(p.effects.foodSov).toBe(0);
      expect(p.effects.trust).toBe(2);
      expect(p.effects.annualRevenue).toBe(0.08);
      expect(p.maxContamination).toBeNull();
      expect(p.stageRequired).toBe('awakening');
    });
    ...
    it('water_transit has correct values', () => {
      ...
      expect(p.category).toBe('infrastructure');
      expect(p.baseCost).toBe(1.50);
      expect(p.baseDuration).toBe(18);
      expect(p.effects.tileEco).toBe(3);
      expect(p.effects.foodSov).toBe(0);
      expect(p.effects.trust).toBe(4);
      expect(p.effects.annualRevenue).toBe(0.05);
      expect(p.maxContamination).toBeNull();
  ...
  describe('Community projects (awakening)', () => {
    it('maker_space has correct values', () => {
      ...
      expect(p.baseCost).toBe(0.15);
      expect(p.baseDuration).toBe(9);
      expect(p.effects.tileEco).toBe(0);
      expect(p.effects.foodSov).toBe(0);
      expect(p.effects.trust).toBe(4);
      expect(p.effects.annualRevenue).toBe(0.04);
      expect(p.maxContamination).toBeNull();
      expect(p.stageRequired).toBe('awakening');
    });
    ...
    it('community_kitchen has correct values', () => {
      ...
      expect(p.baseDuration).toBe(9);
      expect(p.effects.tileEco).toBe(0);
      expect(p.effects.foodSov).toBe(6);
      expect(p.effects.trust).toBe(3);
      expect(p.effects.annualRevenue).toBe(0.01);
      expect(p.maxContamination).toBe(50);
      expect(p.stageRequired).toBe('awakening');
    });
    ...
    it('land_trust has correct values', () => {
      ...
      expect(p.name).toBe('Community Land Trust');
      expect(p.category).toBe('community');
      expect(p.baseCost).toBe(0.20);
      expect(p.baseDuration).toBe(9);
      expect(p.effects.tileEco).toBe(0);
      expect(p.effects.foodSov).toBe(0);
      expect(p.effects.trust).toBe(5);
      expect(p.effects.annualRevenue).toBe(0);
      expect(p.maxContamination).toBeNull();
      expect(p.stageRequired).toBe('awakening');
    });
  ...
  describe('Restoration projects (transition)', () => {
    it('wetland_restoration has correct values', () => {
      ...
      expect(p.baseCost).toBe(0.80);
      expect(p.baseDuration).toBe(15);
      expect(p.effects.tileEco).toBe(18);
      expect(p.effects.foodSov).toBe(2);
      expect(p.effects.trust).toBe(0);
      expect(p.effects.annualRevenue).toBe(0);
      expect(p.maxContamination).toBeNull();
    ...
    it('wildlife_corridor has correct values', () => {
      ...
      expect(p.category).toBe('restoration');
      expect(p.baseCost).toBe(1.20);
      expect(p.baseDuration).toBe(18);
      expect(p.effects.tileEco).toBe(15);
      expect(p.effects.foodSov).toBe(0);
      expect(p.effects.trust).toBe(2);
      expect(p.effects.annualRevenue).toBe(0);
      expect(p.maxContamination).toBeNull();
    ...
    it('regional_collab has correct values', () => {
      ...
      expect(p.category).toBe('restoration');
      expect(p.baseCost).toBe(0.60);
      expect(p.baseDuration).toBe(12);
      expect(p.effects.tileEco).toBe(0);
